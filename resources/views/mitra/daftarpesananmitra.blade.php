    ...
    <div class="container">
        <div class="row mb-5 mt-5">
            ...
            <div class="col-sm-8">
                ...
                <body>
                    <ul class="nav nav-pills gap-3 border p-4 d-flex justify-content-center my-3" id="pills-tab"
                        role="tablist">
                        <li class="nav-item" role="presentation">
                            <button class="nav-link pane active" id="pills-home-tab" data-bs-toggle="pill"
                                data-bs-target="#available" type="button" role="tab" aria-controls="available"
                                aria-selected="true">Available</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link pane" id="pills-profile-tab" data-bs-toggle="pill"
                                data-bs-target="#ongoing" type="button" role="tab" aria-controls="ongoing"
                                aria-selected="false">Ongoing</button>
                        </li>
                        <li class="nav-item" role="presentation">
                            <button class="nav-link pane" id="pills-contact-tab" data-bs-toggle="pill"
                            ...
                            @foreach ($pesanan as $p)
                                <div class="card mt-2" style="box-shadow: 0px 4px 2px rgba(0, 0, 0, 0.1);">
                                    ...
                                    <div class="d-flex justify-content-center my-3">
                                        <a href="/mitra/pesanan/detailpesanan/{{ $p->id }}"
                            ...
                            <div>
                                @foreach ($pesanan_ongoing as $p)
                                    <div class="card mt-2" style="box-shadow: 0px 4px 2px rgba(0, 0, 0, 0.1);">
                                        ...
                                        <div class="d-flex justify-content-center my-3">
                                            <a href="/mitra/pesanan/detailAmbilPesanan/{{ $p->id }}"
                            ...
                            <div>
                                @foreach ($pesanan_finish as $p)
                                    <div class="card" style="box-shadow: 0px 4px 2px rgba(0, 0, 0, 0.1);">
                                        ...
                                        <div class="d-flex justify-content-center my-3">
                                            <a href="/mitra/pesanan/detailSelesaikanPesanan/{{ $p->id }}"
                                ...
                                <div class="card-body">
                                    <div class="row">
                                        ...
                                        <div class="col-4">
                                            ...
                                            <img class="img-pesanan border shadow"
                                                src="/bukti_selesai/{{ $p->bukti_selesai }}" alt="gambar">
                                        </div>
                                    </div>
                                </div>
                            </div>
