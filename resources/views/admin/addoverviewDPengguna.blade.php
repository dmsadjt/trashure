        ...
        <form action="/store" method="post">
            ...
            <div>
                    ...
                    <div class="form-group">
                        ...
                        Address<textarea class="form-control" type="text" name="alamat" required="required"> </textarea> <br />
                        ...
                        Balance <input class="form-control" name="balance" required="required"> <br />
                    </div>
                </div>
